...
####  you can use double qoutes and single also("hello",'hello')
cprint('spy chat', 'green', 'on_red')
print spy.name
### Default Message../////
...
def read_message():
    ...
    output_path = 'kk.png'
    print Steganography.decode(output_path)
    new_chat = {
        "message": output_path,
        "time": datetime.now(),
        "sent_by_me": False
